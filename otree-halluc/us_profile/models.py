...
choice_relig= [['1-Protestant','1-Protestant'],['2-Roman Catholic','2-Roman Catholic'],['3-Mormon','3-Mormon'],['4-Eastern or Greek Orthodox' ,'4-Eastern or Greek Orthodox'],
               ['5-Jewish','5-Jewish'],
               ['6-Muslim','6-Muslim'],['7-Buddhist','7-Buddhist'],['8-Hindu','8-Hindu'],['9-Atheist','9-Atheist'],['10-Agnostic','10-Agnostic'],
               ['11-Nothing in particular','11-Nothing in particular'],['12-Something else','12-Something else']]
...
class Player(BasePlayer):
    ...
    residence = models.StringField(label='What is your State of Residence?',choices=list_of_states,blank=True)

    ownhome = models.StringField(choices=['1-Own','2-Rent','3-Other'], label='Do you own your home?', widget=widgets.RadioSelect,blank=False)
